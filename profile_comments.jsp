<!-- 
need implement : from bookmark link jump to detail page
pic of the food instead of sign
-->
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="sign">
		...
		1 Bookmarks &nbsp;&nbsp;&nbsp; <img src="review.jpg" alt="Review"
			style="width: 3%"> &nbsp; 1 Reviews <br> <br> 
	...
	<br>
	<div id = "bookmark">
	<img src="bookmark.jpg" alt="Bookmark" style="width: 8%"> &nbsp;
	you bookmarked  <a href="">Habit Burger</a>
	</div>
	<br>
	<div id = "review">
	<img src="review.jpg" alt="Bookmark" style="width: 8%"> &nbsp;
	you reviewed  <a href="">Teriyaki Charburger </a>in <a href="">Habit Burger</a>
	</div>
	</div>
	...
	<!-- <div id="comments"><a href="" style="display:block;width:250px;height:250px;">Link</a></div> -->

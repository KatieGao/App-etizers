...
INSERT INTO ingredients (ingredient_name)
  VALUES ('soup'),
         ...
         ('bowl'),
         ('burger'),
         ('sandwich'),tomatoes, corn, chillies, vegan, healthy, vegetarian,salad, beans, corn, chicken,
	 salad, chicken, tomatoes, corn, beans, cabbage, avocado,pasta, chicken, pepper, noodles
         ('tomatoes'),
         ('corn'),
         ('chillies'),
         ('vegan'),
